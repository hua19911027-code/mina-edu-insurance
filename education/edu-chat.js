(function () {
  ...
  const SCRIPT = {
    ...
    round3_body: {
      '英文': '很多家長跟我們說，來之前孩子一看到英文就皺眉，說不想學；來了幾堂課之後，孩子回家主動拿英文繪本在唸，還問媽媽「這個單字怎麼唸？」\n\n徐薇英文的老師透過遊戲和互動，讓孩子在快樂的氣氛中學英文，從自然發音到開口說話，目標是讓孩子真的敢開口、喜歡說。',
      '數學': '很多家長跟我們說，來之前孩子看到數學作業就說頭痛，寫到一半就放棄；上了幾堂課之後，孩子回家寫數學，媽媽問「這題難不難？」孩子說「還好啊，我知道怎麼想。」\n\n偉智數學的老師用啟發式教學，讓孩子從理解出發，不靠死記。很多孩子從「覺得數學很可怕」變成「我懂了」——那個轉變，家長都說看到了。',
      '安親': '我們的安親不只是有人顧。每天放學，老師陪孩子把作業寫完、考前幫忙複習，連生活上的小事——學洗碗、人際關係的小摩擦——老師都會陪著處理；每隔一兩個月還有專業理髮師來幫孩子剪髮，家長不用再煩惱這件事。很多家長說：孩子來安親之後，回家不用再催功課，親子關係都變好了。'
    }
  };
