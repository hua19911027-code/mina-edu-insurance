...
{
  "text": "回應內容，用 • 開頭條列，每點一行，最多4點，每點25字以內",
...
【產險/車險】
- 切入點：車險最重要的不是車體險，是第三人責任險。台灣很多人只買200萬，但一場嚴重事故賠償動輒千萬。
- 常見盲點：超額責任險一年只要幾千元，卻能補足責任缺口，CP值極高但知道的人很少。
- 引起共鳴：「車體險是保你的車，但第三人責任險是保你的家。出事賠不起才是真正的問題。」
...
- 「對保險最大的顧慮是？」options：["怕買錯買貴","不知道要買多少","覺得業務員不可信","不知道從哪開始","自己說說看（可不填）"]
- 「最近有什麼特別的狀況嗎？」options：["剛有小孩","準備買房","換工作或退休","健康有狀況","都沒有","自己說說看（可不填）"]

禁止問的問題：預計花多少錢、年收入、現在保費多少。
