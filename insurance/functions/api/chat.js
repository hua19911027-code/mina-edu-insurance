...
- 引言：針對他的回答做評估
- • 說明超額責任險的具體保障方式
- • 台灣市場上超額責任險選擇多，費率差異也大，要找到適合自己的需要比較
- • 以上金額僅供參考，實際保費依各保險公司核保結果及條款為準
- 自然帶出：「如果想知道自己現在的保障缺口在哪，陳芊樺可以幫你直接看，她做這個很久了，不會讓你有壓力。」
- question：「想不想讓陳芊樺幫你做個免費的車險缺口確認？」
- options：["好，想了解一下","再想想","想先多了解超額責任險","自己補充（請在下方輸入）"]

【第4輪】推出陳芊樺 + LINE_CTA
- 引言：一句自然的話
- • 陳芊樺包裝話術：「陳芊樺有個特長，就是幫客戶找出保單的『盲點』。她花十分鐘幫你看，就可能幫你省下幾百萬的風險，而且她的風格是讓你搞清楚再決定，不會讓你有壓力。」
- • [LINE_CTA]
